...
import com.weligood.mianshiya.constant.CommonConstant;
import com.weligood.mianshiya.exception.BusinessException;
import com.weligood.mianshiya.exception.ThrowUtils;
import com.weligood.mianshiya.mapper.QuestionBankQuestionMapper;
import com.weligood.mianshiya.model.dto.questionBankQuestion.QuestionBankQuestionQueryRequest;
import com.weligood.mianshiya.model.entity.Question;
import com.weligood.mianshiya.model.entity.QuestionBank;
import com.weligood.mianshiya.model.entity.QuestionBankQuestion;
import com.weligood.mianshiya.model.entity.User;
import com.weligood.mianshiya.model.vo.QuestionBankQuestionVO;
import com.weligood.mianshiya.model.vo.UserVO;
import com.weligood.mianshiya.service.QuestionBankQuestionService;
...
import com.weligood.mianshiya.utils.SqlUtils;
...
//        }
    ...
    public void batchAddQuestionsToBank(List<Long> questionIdList, long questionBankId, User loginUser) {
        ...
        for (int i = 0; i < totalQuestionListSize; i += batchSize) {
            ...
            // 使用事务处理每批数据
            // 获取代理
            // 为什么在一个类内部调用事务方法 需要使用代理类?
            // 因为 Spring 的事务管理是基于 AOP（面向切面编程）实现的，而 AOP 的底层机制是“动态代理”。
            // 当你直接在类内部调用方法时，你绕过（Bypass）了代理对象，直接调用了目标对象本身，导致事务切面逻辑无法执行。
